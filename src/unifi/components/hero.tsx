    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-20 pt-20 sm:px-6 sm:pt-28 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-surface-border bg-surface/60 px-3.5 py-1.5 text-xs font-medium text-muted">
          ...
          <p className="text-balance mx-auto mt-6 max-w-2xl text-base text-muted sm:text-lg">
            {t("subheadline")}
          </p>
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <a
              href="#contact"
              className="inline-flex w-full items-center justify-center gap-1.5 rounded-full bg-accent px-6 py-3 text-sm font-medium text-on-accent transition-transform hover:scale-[1.02] sm:w-auto"
            >
              {t("ctaPrimary")}
            ...
            <a
              href="#services"
              className="inline-flex w-full items-center justify-center gap-1.5 rounded-full border border-surface-border px-6 py-3 text-sm font-medium text-foreground transition-colors hover:border-accent/50 hover:bg-surface sm:w-auto"
            >
              {t("ctaSecondary")}
            </a>
          </div>
        ...
        <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-3 gap-4 border-t border-surface-border pt-10">
          {stats.map((stat) => (
