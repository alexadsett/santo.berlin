...
export const hero = {
  de: {
    ...
    body: "santo.berlin entwickelt Onlineshops auf Shopware und verbindet sie mit Pickware zu einer durchgängigen Warenwirtschaft. Als zertifizierter Pickware Partner sorgen wir dafür, dass Shop, Lager und Buchhaltung zusammenspielen – von der ersten Idee bis zum täglichen Betrieb.",
  ...
  en: {
    ...
    body: "santo.berlin builds online stores on Shopware and connects them to Pickware for seamless inventory and fulfilment. As a certified Pickware partner, we make sure your shop, warehouse, and accounting work together — from the first idea to daily operations.",
