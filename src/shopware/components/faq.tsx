    ...
    >
      <div className="mx-auto max-w-3xl px-6 py-20 md:py-28">
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-6 font-display text-4xl leading-[1.1] tracking-tight text-ink sm:text-5xl">
            {t.title}
          </h2>
        </div>

        <div className="mt-12 divide-y divide-line rounded-2xl border border-line bg-cream">
          {t.items.map((item) => (
